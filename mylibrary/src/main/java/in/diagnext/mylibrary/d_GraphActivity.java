...
public class d_GraphActivity extends AppCompatActivity {
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            if (item.getItemId() == R.id.navigation_home) {
                Intent intent = new Intent(d_GraphActivity.this, d_MainActivity.class);
                startActivity(intent);
                finish();
            }
            else if (item.getItemId() == R.id.navigation_report)
            {
                Intent intent1 = new Intent(d_GraphActivity.this, d_GraphActivity.class);
            ...
            {
                Intent intent3=new Intent(d_GraphActivity.this, d_MoreActivity.class);
    ...
    private long dbDate;
    ArrayList<d_StepMaster> list=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.diag_activity_graph);
    ...
    public void bindData()
    {
        ...
        for(int i=0;i<ss.size();i++)
        {
            ...
            list.add(new d_StepMaster(ss.get(i).date,ss.get(i).steps));
