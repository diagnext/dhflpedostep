...
public class d_Database extends SQLiteOpenHelper {
...
//, km REAL, kcal REAL, time INTEGER
    ...
    public d_Database(Context context) {
    ...
    public ArrayList<d_StepMaster> getSteps(String value)
    {
        ArrayList<d_StepMaster> dStepMasterArrayList = new ArrayList<d_StepMaster>();
        ...
        try (Cursor cursor = getReadableDatabase().rawQuery(selectQuery, null)) {
            ...
            if (cursor.getCount() >= 1) {
                ...
                d_StepMaster dStepMaster = new d_StepMaster();
                dStepMaster.setSteps(cursor.getInt(cursor.getColumnIndex("steps")));

                dStepMasterArrayList.add(dStepMaster);
            }
        }

        return dStepMasterArrayList;
    }

    public ArrayList<d_StepMaster> getWeeklySteps() {
        ArrayList<d_StepMaster> dStepMasterArrayList = new ArrayList<d_StepMaster>();
        ...
        try (Cursor cursor = getReadableDatabase().rawQuery(selectQuery, null)) {
            ...
            if (cursor != null) {
                if (cursor.moveToFirst()) {
                    ...
                    do {
                        d_StepMaster dStepMaster = new d_StepMaster();
                        dStepMaster.setDate(cursor.getLong(cursor.getColumnIndex("date")));
                        dStepMaster.setSteps(cursor.getInt(cursor.getColumnIndex("steps")));
                        dStepMasterArrayList.add(dStepMaster);
