...
public class d_RegistrationActivity extends AppCompatActivity {
    int gender=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.daig_activity_registration);
    ...
    public void submit_Click(View view) {
        ...
        pd = new ProgressDialog(d_RegistrationActivity.this);
    ...
    public void insertUser()
    {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(d_RegistrationActivity.this.getResources(),
                R.drawable.avatar);
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        bitmap.compress(Bitmap.CompressFormat.PNG, 100, baos);
        // String imageEncoded = Base64.encodeToString(baos.toByteArray(), Base64.DEFAULT);

        String key = mfdb.getReference("d_UserMaster").push().getKey();

        d_UserMaster pm = new d_UserMaster();
        pm.setUserId(key);
        ...
        mfdb.getReference("d_UserMaster").child(key).setValue(pm);
        ...
        Intent intent = new Intent(d_RegistrationActivity.this, d_MainActivity.class);
    ...
    public void male_Click(View view) {
        ...
        btnMale.setTextColor(ContextCompat.getColor(d_RegistrationActivity.this, R.color.white));
        ...
        btnFeMale.setTextColor(ContextCompat.getColor(d_RegistrationActivity.this, R.color.black));
    ...
    public void female_Click(View view) {
        ...
        btnFeMale.setTextColor(ContextCompat.getColor(d_RegistrationActivity.this, R.color.white));
        ...
        btnMale.setTextColor(ContextCompat.getColor(d_RegistrationActivity.this, R.color.black));
    ...
    public void btnEnable()
    {
        ...
        btnSubmit.setBackgroundColor(ContextCompat.getColor(d_RegistrationActivity.this, R.color.button));
        btnSubmit.setTextColor(ContextCompat.getColor(d_RegistrationActivity.this, R.color.white));

    }
    public void btnDisable()
    {
        btnSubmit.setEnabled(false);
        btnSubmit.setBackgroundColor(ContextCompat.getColor(d_RegistrationActivity.this, R.color.grey));
        btnSubmit.setTextColor(ContextCompat.getColor(d_RegistrationActivity.this, R.color.white));
    }
