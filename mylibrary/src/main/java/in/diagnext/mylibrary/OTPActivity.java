        ...
        pinview.setPinViewEventListener(new Pinview.PinViewEventListener() {
            ...
            public void onDataEntered(Pinview pinview, boolean b) {
                ...
                if(otp.equals(pinview.getValue())) {
                    ...
                    mfdb.getReference().child("UserMaster").orderByChild("userMobile").equalTo(getIntent().getStringExtra("mobile").toString()).addListenerForSingleValueEvent(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if(dataSnapshot.exists())
                            {
                                ...
                                for (DataSnapshot PackageSnapShot : dataSnapshot.getChildren()) {
                                    UserMaster pm = PackageSnapShot.getValue(UserMaster.class);
                                    userId=pm.getUserId();
                                    name=pm.getUserName();
                                    gender = pm.isGender();
                                    height = pm.height;
